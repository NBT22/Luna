...
function(findVulkan)
    ...
    if (NOT Vulkan_volk_FOUND)
        ...
        if (NOT (VOLK_VERSION STREQUAL ${_LUNA_PACKAGE_LATEST_RELEASE_VERSION}))
            message(AUTHOR_WARNING "Volk version ${VOLK_VERSION} does not match headers version ${_LUNA_PACKAGE_LATEST_RELEASE_VERSION}!")
        endif ()
        target_link_libraries(VulkanLibrary INTERFACE volk::volk)
        target_include_directories(volk PUBLIC ${VULKAN_HEADERS_SOURCE_DIR}/include)
    else ()
        target_link_libraries(VulkanLibrary INTERFACE Vulkan::Headers Vulkan::volk)
    endif ()
