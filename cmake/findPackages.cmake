...
macro(findVulkan)
    ...
    if (NOT Vulkan_FOUND)
        ...
        target_compile_options(VulkanLibrary INTERFACE "SHELL:-isystem ${VULKAN_LOADER_SOURCE_DIR}/loader")
...
macro(fetchVMA)
    ...
    if (NOT VMA_FOUND)
        ...
        target_compile_options(VMA INTERFACE "SHELL:-isystem ${vma_SOURCE_DIR}/include")
...
macro(fetchLodePNG)
    ...
    target_compile_options(LodePNG INTERFACE "SHELL:-isystem ${CMAKE_BINARY_DIR}/_deps/lodepng")
