                                       ...
                                       LunaGraphicsPipeline *pipeline)
{
    ...
    CHECK_RESULT(lunaCreateImage(device, commandBuffer, &imageCreationInfo, NULL));
    free(pixels);
...
int main(void)
{
    ...
    CHECK_RESULT(lunaWriteDataToBuffer(device, commandBuffer, indexBuffer, &indexBufferWriteInfo));
